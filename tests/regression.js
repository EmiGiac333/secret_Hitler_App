...
assert.equal(state.roles[5].role, 'liberal', 'la modifica deve attendere la conferma privata');
clickModal({ cp: 'show-radicalised', idx: '5' });
const turnBeforeRoleRefresh = state.turn;
clickModal({ cp: 'finish-radicalisation' });
